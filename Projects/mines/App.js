...
import LevelSecation from './src/screens/LevelSecation'
...
export default class App extends Component {
  ...
  onOpenField = (row, column) => {
    ...
    if (lost) {
      showMines(board)
      Alert.alert('Perdeeeeeu!','Que burro, da zero pra ele!' )
    }
  ...
  render() {
    return(
      <View style={styles.container}>
        <LevelSecation isVisible={this.state.showLevelSelection} onLevelSelected={this.onLevelSelected} onCancel={() => this.setState({showLevelSelection: false})}/>
